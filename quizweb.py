...
# Kiểm tra nếu index hiện tại nằm ngoài range của chuyên đề đã chọn
...
if total_in_topic > 0:
    ...
    # Định nghĩa row bên trong khối if này
    row = df.iloc[st.session_state.current_index]

    # 👇 TOÀN BỘ PHẦN NÀY PHẢI ĐƯỢC THỤT LỀ VÀO TRONG KHỐI IF
    # Hiển thị câu hỏi
